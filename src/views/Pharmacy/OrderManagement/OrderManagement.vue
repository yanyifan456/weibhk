<template>
    <div class="remote-consultation">
                ...
                <div style="display: flex; flex-direction: column">
                    ...
                    <div style="width: 1000px; display: flex; justify-content: space-between; margin-top: 20px">
                        ...
                        <a-form-item :label="t('receipt.logisticsNo')">
                            <a-input v-model:value="searchForm.logisticsNo" :placeholder="t('receipt.enterLogisticsNo')"
                                style="width: 200px" />
                        </a-form-item>
                    </div>
                </div>
                    ...
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.key === 'logisticsNo'">
                            <a-popconfirm title="是否确认发货" ok-text="是" cancel-text="否"
                                ...
                                <a-button type="link" :disabled="!record.wdlExportCertificate || !!record.logisticsNo">
        ...
        <!-- 药品详情弹窗 -->
        <a-modal v-model:open="medicineModalVisible" :title="t('receipt.medicineDetail')" width="100%" :footer="null">
        ...
        <a-modal v-model:open="logisticsModalVisible" :title="t('receipt.editLogisticsNo')" width="400px"
            ...
            <a-form layout="vertical">
                <a-form-item :label="t('receipt.logisticsNo')">
                    <a-input v-model:value="logisticsForm.logisticsNo" :placeholder="t('receipt.enterLogisticsNo')" />
                </a-form-item>
            </a-form>
        </a-modal>
