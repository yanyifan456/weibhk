...
import { getExpenseBill, deleteExpenseBill } from "@/api/api1";
...
const columns = computed(() => [
  ...
  {
    title: t("payOutTableHeader.payTime"),
    dataIndex: "tradeTime",
    key: "tradeTime",
    align: "center",
    width: 100,
  ...
  {
    title: t("payOutTableHeader.receiver"),
  ...
  {
    title: t("payOutTableHeader.paymentMethod"),
    dataIndex: "payType",
    key: "payType",
    align: "center",
    width: 100,
  ...
  {
    title: t("payOutTableHeader.category"),
  ...
  {
    title: t("payOutTableHeader.amount"),
    dataIndex: "paidFee",
    key: "paidFee",
    align: "center",
    width: 100,
...
const getData = async () => {
  const params = {
    tradeTime: select.value,
    currentPage: pagination.current,
    pageSize: pagination.pageSize,
  };
  try {
    const res = await getExpenseBill(params);
